package com.blackybear.test.designpattern.structural.Bridge;
...
public class BridgePattern {
    public static void main(String[] args){
        ...
        RedefinedAbstraction redefinedAbstraction = new RedefinedAbstraction();
        redefinedAbstraction.setImplementor(implementor);
        redefinedAbstraction.operation();
    }
}
